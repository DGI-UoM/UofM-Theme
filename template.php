...
function UofM_preprocess_maintenance_page(&$variables, $hook) {
  ...
  UofM_preprocess_html($variables, $hook);
  UofM_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function UofM_preprocess_page(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function UofM_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // UofM_preprocess_node_page() or STARTERKIT_preprocess_node_story().
